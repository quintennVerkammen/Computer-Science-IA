...
public class Comment {
	...
	private static final String[] introA = {" has shown excellent work ethic and understanding of the subjects at hand throughout the semester. ",
	...
	private static final String[] introB = {" has shown good work ethic and understading of the subjects at hand throughout the semester. ",
	...
	private static final String[] introC = {" could have shown better work ethic and more investment during the past semester. ",
	...
	private static final String[] introF = {" has shown poor work ethic and understanding of the topics covered during the past semester. ",
	...
	private static final String[] suggestionA = {"I would suggest them to keep doing what they are doing as it clearly offers excellent results. ",
	...
	private static final String[] suggestionB = {"I suggest they keep doing what they are doing, and with a little bit more effor they could achieve excellence. ",
	...
	private static final String[] suggestionC = {"I suggest that they step up their efforts next semester to achieve what they know they are truly capable of. ",
	...
	private static final String[] suggestionF = {"They need to start focusing and really putting in the work in class, as this grade does not reflect what i know they are truly capable of. ",
	...
	private static final String[] improvementA = {"No improvement is needed, I simply need them to keep doing what they are doing to maintain their excellent grades. ",
	...
	private static final String[] improvementB = {"This student has great potential, and with a bit more work, I am confident that they can achieve even better grades. ",
	...
	private static final String[] improvementC = {"Their grade is not reflective of their potential, but with some more work, this potential can be truly realized. ",
	...
	private static final String[] improvementF = {"Improvement is strongly needed, and I expect to see this in the coming semesters. ",
	...
	private static final String[] conclusionA = {"For now there is nothing left to say but to wish you a nice holiday!",
	...
	private static final String[] conclusionB = {"If this student could review what we have covered in class over the holidays, I am sure their grade would improve instantly!",
				"I hope you enjoy your holidays!",
				"In conclusion, a tiny bit more work would turn their grades from simply good to excellent."};
	private static final String[] conclusionC = {"I would encourage them to work on class topics over the holiday to improve their grades over the coming semester.",
	...
	private static final String[] conclusionF = {"I expect them to review classwork over the holidays to be able to start the new semester with a refreshed mentality.",
	...
	private static String generateComment(double percentage) {
